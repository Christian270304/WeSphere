...
export class ProfileComponent {
  ...
  private loadProfile() {
    this.route.paramMap.pipe(takeUntil(this.destroy$)).subscribe((params) => {
      ...
      if (!usernameFromUrl) {
        ...
        this.loadUserByUsername(usernameFromUrl);
      }
    });
  }
  ...
  private loadUserByUsername(username: string) {
    this.userService
      ...
      .subscribe((profileUser) => {
        if (profileUser) {
          ...
          this.noExists = false;
          this.handlePrivateProfile(profileUser);
        } else {
          this.noExists = true;
  ...
  private handlePrivateProfile(profileUser: any) {
  ...
  hayCambios(): boolean {
    ...
    this.datosEditados = { username, bio, profileImage: newProfileImage, bannerImage: newBannerImage };
